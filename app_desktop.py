...
class CbTreeview(ttk.Treeview):
    def __init__(self, master, font_name, font_size, **kw):
        ...
        style.configure("cb.Treeview.Heading", font=(font_name, font_size, 'bold'))
...
class SettingsDialog(Dialog):
    ...
    def setSettingsUI(self):
        ...
        self.ch_sel = tk.Frame(tab_control, borderwidth=1, relief='solid', bg='#ececec')
        self.st_sel = tk.Frame(tab_control, borderwidth=1, relief='solid', bg='#ececec')
        self.filter_sel = tk.Frame(tab_control, borderwidth=1, relief='solid', bg='#ececec')
        self.epoch_sel = tk.Frame(tab_control, borderwidth=1, relief='solid', bg='#ececec')
    ...
    def setChannelSelectionPanel(self):
        ...
        ch_panel = tk.Frame(self.ch_sel, borderwidth=1, relief='solid', bg='#ececec')
        ...
        for i in range(len(self.controller.channels_all)):
            ...
            ch_panel_col = tk.Frame(ch_panel, bg='#ececec')
    ...
    def setSleepStageSelectionPanel(self):
        ...
        annotation_panel = tk.Frame(self.st_sel, bg='#ececec')
        annotation_panel.pack(side="left", fill=tk.Y, padx=10, pady=10, expand=True)
        tk.Label(annotation_panel, text='Annotations', bg='#ececec').pack()
        container1 = tk.Frame(annotation_panel, borderwidth=1, relief='solid', bg='#ececec')
        container1.pack(fill=tk.BOTH, expand=True)
        container2 = tk.Frame(container1, bg='#ececec')
        container2.pack(side='top', fill='both', expand=True)
        canvas = tk.Canvas(container2, bg='#ececec')
        ...
        self.st_panel_left = tk.Frame(canvas, bg='#ececec')
        ...
        move_btn_panel = tk.Frame(self.st_sel, width=40, bg='#ececec')
        ...
        annotation_panel1 = tk.Frame(self.st_sel, bg='#ececec')
        ...
        container11 = tk.Frame(annotation_panel1, borderwidth=1, relief='solid', bg='#ececec')
        container11.pack(fill=tk.BOTH, expand=True)
        container21 = tk.Frame(container11, bg='#ececec')
        ...
        self.st_panel_right = tk.Frame(canvas1, bg='#ececec')
    ...
    def setFilterSettingsPanel(self):
        ...
        notch_panel = tk.Frame(self.filter_sel, borderwidth=1, relief='solid', bg='#ececec')
        notch_panel.pack(fill=tk.X, padx=10, pady=10)
        ttk.Label(notch_panel, text="Notch filter frequency (Hz):", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=0, column=0, padx=10, sticky='nse')
        ...
        ttk.Label(bandpass_panel, text="Minimum frequency (Hz):", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=0, column=0, padx=10, sticky='nse')
        ...
        ttk.Label(bandpass_panel, text="Maximum frequency (Hz):", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=1, column=0, padx=10, sticky='nse')
        ...
        amplitude_max_panel = tk.Frame(self.filter_sel, borderwidth=1, relief='solid', bg='#ececec')
        amplitude_max_panel.pack(fill=tk.X, padx=10, pady=10)
        ttk.Label(amplitude_max_panel, text="Maximum amplitude (micro Volt):", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=0, column=0, padx=10, sticky='nse')
        ...
        ttk.Label(flat_signal_filter_panel, text="Duration (seconds):", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=0, column=0, padx=10, sticky='nse')
        ...
        ttk.Label(flat_signal_filter_panel, text="Minimum frequency standard deviation in flat signal duration:", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=1, column=0, padx=10, sticky='nse')
        ...
        ttk.Label(flat_signal_filter_panel, text="Minimum frequency standard deviation in an epoch:", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=2, column=0, padx=10, sticky='nse')
        ...
        container1 = tk.Frame(bad_annots_panel, bg='#ececec')
        container1.pack(fill=tk.BOTH, expand=True)
        container2 = tk.Frame(container1, bg='#ececec')
    ...
    def setEpochSizePanel(self):
        ...
        epoch_size_panel = tk.Frame(self.epoch_sel, borderwidth=1, relief='solid', bg='#ececec')
        epoch_size_panel.pack(fill=tk.X, padx=10, pady=10)
        ttk.Label(epoch_size_panel, text="Epoch Size (Seconds):", width=63, anchor='e', font=(self.font_name, self.font_size-2)).grid(row=0, column=0, padx=10, sticky='nse')
...
class MainDialog(Dialog):
    ...
    def setInputPanel(self):
        ...
        # Set input panel
        input_panel = tk.Frame(self.master, width=self.width-20, height=int(self.height*0.3), borderwidth=1, relief='groove', bg='#ececec')
        input_panel.pack(padx=10)
        input_panel.pack_propagate(0)

        sample_path_panel = tk.Frame(input_panel, bg='#ececec')
        sample_path_panel.pack(fill=tk.X)

        group_panel2 = tk.Frame(sample_path_panel, width=200, borderwidth=1, relief='groove', bg='#ececec')
        ...
        group_panel1 = tk.Frame(sample_path_panel, borderwidth=1, relief='groove', bg='#ececec')
        ...
        group_panel = tk.Frame(input_panel, bg='#ececec')
        group_panel.pack(fill=tk.X)

        settings_type_panel = tk.Frame(group_panel, width=200, borderwidth=1, relief='groove', bg='#ececec')
        ...
        sample_type_panel = tk.Frame(group_panel, borderwidth=1, relief='groove', bg='#ececec')
        ...
        sample_type_option_panel = tk.Frame(sample_type_panel, borderwidth=1, relief='groove', bg='#ececec')
        ...
        output_path_panel = tk.Frame(group_panel, borderwidth=1, relief='groove', bg='#ececec')
    ...
    def setOutputPanel(self):
        ...
        output_panel = tk.Frame(self.master, width=self.width-20, height=int(self.height*0.7), borderwidth=1, relief='groove', bg='#ececec')
        ...
        self.ct_options = tk.Frame(self.tab_control, bg='#ececec')
        ...
        cut_table_container = tk.Frame(self.ct_options, height=100, borderwidth=1, relief='solid', bg='#ececec')
